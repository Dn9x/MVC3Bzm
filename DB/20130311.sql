...
INSERT INTO bzm_access VALUES ('691', 'http://localhost:4894/', '127.0.0.1', '127.0.0.1', 'Chrome25.0 Chrome25', '2013-03-10 22:41:52');
INSERT INTO bzm_access VALUES ('692', 'http://localhost:4894/', '127.0.0.1', '127.0.0.1', 'Chrome25.0 Chrome25', '2013-03-11 22:25:35');
INSERT INTO bzm_access VALUES ('693', 'http://localhost:4894/Home/Detail/60', '127.0.0.1', '127.0.0.1', 'Chrome25.0 Chrome25', '2013-03-11 22:25:45');
...
-- ----------------------------
-- Table structure for `bzm_error`
-- ----------------------------
DROP TABLE IF EXISTS `bzm_error`;
CREATE TABLE `bzm_error` (
  `Id` int(11) NOT NULL auto_increment COMMENT '主键自增',
  `error_msg` longtext NOT NULL COMMENT '错误信息的内容',
  `error_date` timestamp NOT NULL default '0000-00-00 00:00:00' on update CURRENT_TIMESTAMP COMMENT '发生错误的时间',
  PRIMARY KEY  (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of bzm_error
-- ----------------------------
INSERT INTO bzm_error VALUES ('1', '*目前操作中的主機：http://localhost:4894/取不到錯誤資訊。', '2013-03-11 22:29:18');
